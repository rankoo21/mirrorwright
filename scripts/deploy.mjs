// Deploy MirrorwrightContract to a GenLayer network.
//
...
// .env.deploy as MIRROR_CONTRACT_ADDRESS, and prints the frontend env lines.
...
async function main() {
  ...
  console.log("Waiting for receipt (this can take a few minutes on Bradbury)...");
